...
public class AcidClotBulletType extends BulletType{
    ...
    public AcidClotBulletType(float speed, float damage){
        super(speed, damage);
    }

    public AcidClotBulletType(){}
