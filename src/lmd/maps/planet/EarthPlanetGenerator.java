...
public class EarthPlanetGenerator extends PlanetGenerator{
        ...
        {Blocks.deepwater, Blocks.sandWater, Blocks.sand, Blocks.sand, Blocks.basalt, Blocks.moss, Blocks.basalt, Blocks.hotrock, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice},
        {Blocks.sandWater, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.moss, Blocks.grass, Blocks.snow, Blocks.basalt, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice},
        ...
        {Blocks.deepwater, Blocks.sandWater, Blocks.sand, Blocks.grass, Blocks.grass, Blocks.ice, Blocks.ice, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
        {Blocks.sandWater, Blocks.sandWater, Blocks.sand, Blocks.grass, Blocks.moss, Blocks.grass, Blocks.iceSnow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
        ...
        protected void generate(){
                            ...
                            for(int y = -rad; y <= rad; y++){
                                ...
                                if(Structs.inBounds(wx, wy, width, height) && Mathf.within(x, y, rad)){
                                    ...
                                    if(Mathf.within(x, y, rad - 1) && !other.floor().isLiquid){
                                        ...
                                        //TODO does not respect  floors
                                        other.setFloor((Floor)(floor == Blocks.sand || floor == Blocks.salt ? Blocks.sandWater : Blocks.sandWater));
                                    }
                                }
                            }
                        }
            ...
            pass((x, y) -> {
                ...
                if(value > 0.17f && !Mathf.within(x, y, fspawn.x, fspawn.y, 12 + rrscl)){
                    ...
                    boolean spori = floor != Blocks.sand && floor != Blocks.salt;
                    ...
                    if(!(floor == Blocks.ice || floor == Blocks.iceSnow || floor == Blocks.snow || floor.asFloor().isLiquid)){
                        floor = spori ?
                            (deep ? Blocks.water : Blocks.sandWater) :
                            (deep ? Blocks.water :
                                (floor == Blocks.sand || floor == Blocks.salt ? Blocks.sandWater : Blocks.sandWater));
                    }
                }
            });
            ...
            pass((x, y) -> {
                ...
                if(floor.asFloor().isLiquid && floor.asFloor().shallow){
                    ...
                    floor = floor == Blocks.sandWater ? Blocks.water : Blocks.water;
                }
            });
            ...
            if(naval){
                ...
                pass((x, y) -> {
                    if(floor.asFloor().isLiquid && !floor.asFloor().isDeep() && !floor.asFloor().shallow){
                        ...
                        floor = floor == Blocks.water ? Blocks.deepwater : Blocks.sandWater;
                    }
                });
            }
            ...
            pass((x, y) -> {
                ...
                if(floor == Blocks.hotrock){
                    ...
                    if(noise > 0.67f && !roomseq.contains(e -> Mathf.within(x, y, e.x, e.y, 14))){
                        if(noise > 0.72f){
                            floor = noise > 0.78f ? Blocks.water : (floor == Blocks.sand ? Blocks.sandWater : Blocks.sandWater);
                        }else{
                            floor = (floor == Blocks.sand ? floor : Blocks.sand);
                        }
                    }
                }
