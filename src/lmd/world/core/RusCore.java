/* package example.world.blocks.core;
 ...
 public class RusCore extends BaseCore implements UpgradesType {
     ...
     public class ResearchedLockedCond implements Boolf<Team>{
         ...
         public boolean get(Team team) {
             return ResearchHandler.get().getData(team, research).unlocked;
         }
     }
 }*/